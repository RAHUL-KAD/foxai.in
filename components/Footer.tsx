...
export default function Footer() {
  return (
    ...
    <footer id="footer" className="p-4 md:p-5 lg:p-5 dark:bg-gray-800 mt-10">
    <div className="mx-auto max-w-screen-xl text-center">
      <a href="/" className="flex justify-center items-center text-2xl font-semibold text-[#333] dark:text-white">
      <Image
              alt="header text"
              src="/favicon.svg"
              className="sm:w-7 sm:h-8 w-7 h-10 mr-3"
              width={8}
              height={8}
          />
          Sonicai    
      ...
      <ul className="flex flex-wrap justify-center items-center mt-5 mb-6 text-[#333] dark:text-white">
          ...
          <li>
              <a href="" className="mr-4 hover:underline md:mr-6">Why Sonicai</a>
          </li>
          {/* <li>
      ...
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">Sonicai™</a>. All Rights Reserved.</span>
  </div>
</footer>
